...
Quantiles is designed to work well with coding agents, and we welcome contributors using them to help draft code, tests, documentation, evaluations, benchmarks, and issue responses. As with any contribution, contributors are responsible for reviewing, understanding, and validating the final work before submitting it.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at security@quantiles.io. All complaints will be reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. The project team is obligated to maintain confidentiality with regard to the reporter of an incident. Further details of specific enforcement policies may be posted separately.
