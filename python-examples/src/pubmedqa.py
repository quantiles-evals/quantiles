...
It uses PubMedQA as an illustrative example, implementing the benchmark as custom code. A registry-backed
PubMedQA definition can also be downloaded and run directly with `qt run pubmedqa`.
